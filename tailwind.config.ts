...
export default {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "fight-pulse": {
          "0%, 100%": {
            "text-shadow": "0 0 10px rgba(0, 229, 255, 1), 0 0 20px rgba(0, 229, 255, 0.8)",
          },
          "50%": {
            "text-shadow": "0 0 20px rgba(0, 229, 255, 1), 0 0 40px rgba(0, 229, 255, 0.9)",
          },
        },
      },
      animation: {
      ...
      boxShadow: {
        glow: "0 0 15px rgba(0, 229, 255, 0.5), 0 0 30px rgba(0, 229, 255, 0.3)",
        "glow-lg": "0 0 25px rgba(0, 229, 255, 0.7), 0 0 50px rgba(0, 229, 255, 0.4)",
        "glow-xl": "0 0 40px rgba(0, 229, 255, 0.8), 0 0 80px rgba(0, 229, 255, 0.5)",
        ...
        "fight-ring": "0 0 20px rgba(0, 229, 255, 0.6), 0 0 40px rgba(0, 229, 255, 0.3), inset 0 0 15px rgba(0, 229, 255, 0.1)",
        steel: "0 8px 32px rgba(0, 0, 0, 0.9), 0 0 15px rgba(0, 229, 255, 0.1)",
      },
      textShadow: {
  ...
  plugins: [
    ...
    function({ addUtilities }: { addUtilities: any }) {
      const newUtilities = {
        '.text-shadow-neon': {
          textShadow: '0 0 10px rgba(0, 229, 255, 0.8), 0 0 20px rgba(0, 229, 255, 0.6), 0 0 30px rgba(0, 229, 255, 0.4)',
        },
        '.text-shadow-neon-strong': {
          textShadow: '0 0 5px #fff, 0 0 10px rgba(0, 229, 255, 1), 0 0 20px rgba(0, 229, 255, 0.8), 0 0 40px rgba(0, 229, 255, 0.6)',
        },
        '.text-shadow-golden': {
