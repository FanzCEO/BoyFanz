...
export class APIGatewayService extends EventEmitter {
  ...
  /**
   * Get health status for orchestration engine
   */
  getHealthStatus(): { healthy: boolean; component: string; details?: any } {
    ...
    return {
      ...
      details: {
        servicesHealthy: metrics.services.healthy,
        servicesTotal: metrics.services.total,
        circuitBreakerEnabled: metrics.circuitBreaker.enabled
      }
    };
  }
}
