...
class AutomatedWorkflowEngine extends EventEmitter {
  ...
  async initialize() {
    try {
      ...
      if (this.commandCenter && typeof this.commandCenter.registerService === 'function') {
  ...
  async setupEventListeners() {
    ...
    if (this.orchestrationEngine && typeof this.orchestrationEngine.on === 'function') {
    ...
    if (this.dataPipeline && typeof this.dataPipeline.on === 'function') {
    ...
    if (this.commandCenter && typeof this.commandCenter.on === 'function') {
