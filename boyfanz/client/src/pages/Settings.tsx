  ...
  const handleFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        // Upload to server
        const response = await apiRequest('POST', '/api/profile/upload-avatar', {
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center gap-6">
                <div className="relative group">
                  <img
                    src={previewUrl || user?.profileImageUrl || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face"}
                    alt="Profile Avatar"
                    className="h-20 w-20 rounded-full ring-2 ring-primary/20 object-cover"
