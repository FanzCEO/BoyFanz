...
function json(params) {
  const jsonSchema2 = lazy(() => {
    return union([string(params), number(), boolean(), _null2(), array(jsonSchema2), record(string(), jsonSchema2)]);
  });
  return jsonSchema2;
}
...
// node_modules/.pnpm/drizzle-zod@0.8.3_drizzle-orm@0.44.7_@neondatabase+serverless@1.0.2_@types+pg@8.15.6_pg@8.16.3__zod@3.25.76/node_modules/drizzle-zod/index.mjs
var CONSTANTS = {
  INT8_MIN: -128,
  INT8_MAX: 127,
...
function numberColumnToSchema(column, z, coerce) {
  ...
  let schema = coerce === true || (coerce == null ? void 0 : coerce.number) ? integer ? z.coerce.number() : z.coerce.number().int() : integer ? z.int() : z.number();
