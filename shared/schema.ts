...
// ===== FANZ ECOSYSTEM / SINGULARITY SCHEMA =====
// Core tables for the FANZ universe architecture

// Ecosystem Platform Status
export const ecosystemPlatformStatus = pgEnum("ecosystem_platform_status", [
  "live",
  "beta",
  "alpha",
  "coming_soon",
...
// FANZ Ecosystem Platforms Registry
export const ecosystemPlatforms = pgTable("ecosystem_platforms", {
  ...
  status: ecosystemPlatformStatus("status").default("coming_soon").notNull(),
...
// System Health / FANZ Nexus Status
...
// FanzDefend - Content Protection
export const contentProtectionStatus = pgEnum("content_protection_status", [
  "active",
  "detected",
  "takedown_sent",
  "resolved",
...
export const contentProtection = pgTable("content_protection", {
  ...
  creatorId: varchar("creator_id").notNull(),
  contentId: varchar("content_id"),
  piracyUrl: text("piracy_url"),
  platform: varchar("platform", { length: 100 }),
  status: contentProtectionStatus("status").default("detected").notNull(),
  detectedAt: timestamp("detected_at").defaultNow().notNull(),
  takedownSentAt: timestamp("takedown_sent_at"),
  resolvedAt: timestamp("resolved_at"),
  notes: text("notes"),
  metadata: jsonb("metadata"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
// FanzFiliate - Affiliate Tracking
...
export const affiliates = pgTable("affiliates", {
  ...
  status: affiliateStatus("status").default("pending").notNull(),
...
export const affiliateReferrals = pgTable("affiliate_referrals", {
  ...
  convertedAt: timestamp("converted_at"),
  totalCommissionEarned: integer("total_commission_earned").default(0),
  isActive: boolean("is_active").default(true),
});

// FanzMeet - Video Calls
...
export const fanzMeetings = pgTable("fanz_meetings", {
  id: bigserial("id", { mode: "number" }).primaryKey(),
...
// StarzCardz - Creator Payment Cards
...
export const starzCards = pgTable("starz_cards", {
  id: bigserial("id", { mode: "number" }).primaryKey(),
  userId: varchar("user_id").notNull(),
  cardType: varchar("card_type", { length: 20 }).default("virtual"),
