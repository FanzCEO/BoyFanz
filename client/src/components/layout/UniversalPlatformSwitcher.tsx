...
const FAN_PLATFORMS: FanzPlatform[] = [
  {
    ...
    logoUrl: '/platforms/boyfanz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/gayfanz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/milffanz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/bearfanz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/fanzuncut-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/femmefanz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
  ...
  },
  {
    ...
    logoUrl: '/platforms/guyz-logo.png', primaryColor: '#475569', secondaryColor: '#d4af37',
...
const AI_SERVICES: FanzPlatform[] = [
  {
    ...
    accentColor: '#94a3b8', backgroundColor: '#0f172a', description: 'AI Chat Assistant',
  ...
  },
  {
    ...
    logoUrl: '/platforms/bot-logo.png', primaryColor: '#64748b', secondaryColor: '#0891b2',
    accentColor: '#94a3b8', backgroundColor: '#18181b', description: 'Automated Assistant',
    category: 'ai_bot', status: 'active', isUserFacing: true, requiresAuth: true,
