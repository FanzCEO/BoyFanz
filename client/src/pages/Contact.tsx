        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div>
                  <p className="text-sm font-semibold">Fanz Unlimited Network LLC</p>
                  <p className="text-xs text-muted-foreground">A subsidiary of FANZ Group Holdings LLC</p>
                </div>
