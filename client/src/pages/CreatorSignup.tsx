      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consentTerms" className="text-df-fog text-sm cursor-pointer">
            I agree to the <a href="/terms" className="text-df-cyan hover:underline" target="_blank">Terms of Service</a> *
          </label>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consentPrivacy" className="text-df-fog text-sm cursor-pointer">
            I agree to the <a href="/privacy" className="text-df-cyan hover:underline" target="_blank">Privacy Policy</a> *
          </label>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consentContentPolicy" className="text-df-fog text-sm cursor-pointer">
            I agree to the <a href="/safety" className="text-df-cyan hover:underline" target="_blank">Content Policy</a> and <a href="/safety" className="text-df-cyan hover:underline" target="_blank">Acceptable Use Policy</a> *
          </label>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="consentDMCA" className="text-df-fog text-sm cursor-pointer">
            I understand the <a href="/safety" className="text-df-cyan hover:underline" target="_blank">DMCA Policy</a> and agree to respect intellectual property rights
          </label>
        </div>
      </div>
    </div>
