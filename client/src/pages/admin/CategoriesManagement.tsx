...
export default function CategoriesManagement() {
  ...
  const { data: contentCategories, isLoading: contentLoading, error: contentError, refetch: refetchContent } = useQuery<any[]>({
    queryKey: [
  ...
  const { data: productCategories, isLoading: productLoading, error: productError, refetch: refetchProducts } = useQuery<any[]>({
    queryKey: [
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-slate-500" data-testid="max-depth">
