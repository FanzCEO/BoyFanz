...
export default function ShopManagement() {
  ...
  const { data: productsData, isLoading: productsLoading, error: productsError, refetch: refetchProducts } = useQuery<any>({
    queryKey: [
      '/api/admin/products',
      {
        searchQuery,
  ...
  const { data: ordersData, isLoading: ordersLoading, error: ordersError, refetch: refetchOrders } = useQuery<any>({
    queryKey: [
      '/api/admin/orders',
      {
        searchQuery,
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-slate-500" data-testid="total-customers">
