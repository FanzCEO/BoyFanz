  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-gray-900 border-slate-500/20">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-slate-400">$18,452</div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card className="bg-gray-900 border-slate-500/20">
            <CardHeader>
              <CardTitle className="text-slate-400">Top Referrers</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
          ...
          <Card className="bg-gray-900 border-slate-500/20">
            <CardHeader>
              <CardTitle className="text-slate-400">Recent Referrals</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card className="bg-gray-900 border-slate-500/20">
            <CardHeader>
              <CardTitle className="text-slate-400">Referral Program Configuration</CardTitle>
            </CardHeader>
          ...
          <Card className="bg-gray-900 border-slate-500/20">
            <CardHeader>
              <CardTitle className="text-slate-400">Referral Link Template</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
