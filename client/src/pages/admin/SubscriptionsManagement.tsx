...
export default function SubscriptionsManagement() {
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gray-900 border-slate-500/20">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-slate-400">7,038</div>
        ...
        <Card className="bg-gray-900 border-slate-500/20">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-slate-400">$84.2K</div>
            <p className="text-gray-400">Monthly Recurring</p>
          </CardContent>
        </Card>
        <Card className="bg-gray-900 border-slate-500/20">
          <CardContent className="pt-6">
            <div className="text-3xl font-bold text-slate-400">94.2%</div>
      ...
      <Card className="bg-gray-900 border-slate-500/20">
        <CardHeader>
          <CardTitle className="text-slate-400">Recent Subscriptions</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
