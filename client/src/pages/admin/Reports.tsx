...
export default function AdminReports() {
  ...
  // Production mode - empty fallback data (reports show real data only)
  ...
  const getCurrentReport = (): ReportData => {
    switch (activeReport) {
      case 'financial': return (financialReport || emptyFinancialReport) as FinancialReport;
      case 'users': return (userReport || emptyUserReport) as UserReport;
      case 'content': return (contentReport || emptyContentReport) as ContentReport;
      case 'compliance': return (complianceReport || emptyComplianceReport) as ComplianceReport;
      default: return null;
    }
  };

  const getUserReport = (): UserReport => {
    return (userReport || emptyUserReport) as UserReport;
  };

  const getContentReport = (): ContentReport => {
    return (contentReport || emptyContentReport) as ContentReport;
  };

  const getComplianceReport = (): ComplianceReport => {
    return (complianceReport || emptyComplianceReport) as ComplianceReport;
  };
