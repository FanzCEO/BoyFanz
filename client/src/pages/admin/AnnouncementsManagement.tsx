...
export default function AnnouncementsManagement() {
  ...
  const handleEditAnnouncement = (announcement: Announcement) => {
    ...
    form.reset({
      ...
      scheduledFor: announcement.scheduledFor ? format(new Date(announcement.scheduledFor), 'yyyy-MM-dd\'T\'HH:mm') : undefined,
      expiresAt: announcement.expiresAt ? format(new Date(announcement.expiresAt), 'yyyy-MM-dd\'T\'HH:mm') : undefined,
      imageUrl: announcement.imageUrl || "",
      linkUrl: announcement.linkUrl || "",
      linkText: announcement.linkText || "",
      isAbTest: announcement.isAbTest ?? false,
      abTestGroup: announcement.abTestGroup || "",
    });
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormDescription>
                                  Specify test group identifier (e.g., A, B)
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
                        ...
                        <TableCell>
                          {announcement.scheduledFor ? (
                            <div className="text-sm">
                              <p>{format(new Date(announcement.scheduledFor), 'MMM dd, yyyy')}</p>
                              <p className="text-muted-foreground">{format(new Date(announcement.scheduledFor), 'HH:mm')}</p>
                            </div>
                          ) : (
