  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-red-900/20">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-red-600/20 to-orange-500/20 backdrop-blur-3xl"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-white mb-4 bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent">
                ...
                {tutorialsData?.tutorials?.map((tutorial) => (
                  <Link key={tutorial.id} href={`/help/tutorials/${tutorial.slug}`}>
                    <Card className="group bg-gray-800/50 border-gray-700 hover:border-red-500/50 transition-all duration-300 hover:scale-105 cursor-pointer h-full">
                      {/* Thumbnail */}
                      <div className="relative h-48 bg-gradient-to-r from-red-600 to-orange-600 rounded-t-lg overflow-hidden">
