    ...
    <div className="min-h-screen bg-[#050505] p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="p-3 rounded-xl bg-gradient-to-br from-[#475569]/20 to-[#d4a959]/20 border border-[#475569]/30">
            <Wallet className="w-8 h-8 text-[#475569]" />
          </div>
          <div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {/* Total Balance */}
          <Card className="bg-gradient-to-br from-[#475569]/10 to-transparent border-[#475569]/30">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-zinc-900/50 border-zinc-800">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-3 rounded-lg bg-gradient-to-r from-[#475569]/20 to-[#d4a959]/20">
                  ...
                  {tokens?.map((token: any) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {token.type === 'fanztoken' && <Zap className="w-4 h-4 text-[#475569]" />}
            ...
            <Card className="bg-zinc-900/50 border-zinc-800">
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <Button variant="outline" className="border-[#475569]/30 hover:bg-[#475569]/10" data-testid="button-transfer" onClick={() => setTransferOpen(true)}>
            ...
            <Card className="bg-zinc-900/50 border-zinc-800">
              ...
              <CardContent className="space-y-4">
                {cards && cards.length > 0 ? (
                  <>
                    {cards.map((card: any) => (
                      <div key={card.id} className="relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-[#475569]/20 via-zinc-900 to-[#d4a959]/20 border border-[#475569]/30">
                        ...
                        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#475569]/10 to-transparent rounded-full blur-3xl"></div>
                      </div>
                    ))}
                    <Button
                      className="w-full bg-[#d4a959] hover:bg-[#b8925e] text-white"
        ...
        <DialogContent className="bg-zinc-900 border-zinc-800">
          <DialogHeader>
            <DialogTitle className="text-white flex items-center gap-2">
              <ArrowUpRight className="w-5 h-5 text-[#475569]" />
              Transfer Funds
            </DialogTitle>
