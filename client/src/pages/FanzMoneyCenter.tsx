                  ...
                  {tokens?.map((token: any) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {token.type === 'loyalty' && <Award className="w-4 h-4 text-orange-500" />}
                        {token.type === 'reward' && <Award className="w-4 h-4 text-red-500" />}
                          ...
                          <div className="flex justify-between items-start mb-6">
                            ...
                            <Badge 
                              ...
                              className={`${
                                ...
                                card.status === 'frozen' ? 'bg-amber-500/20 text-amber-400 border-amber-500/30' :
                                'bg-red-500/20 text-red-400 border-red-500/30'
                              }`}
