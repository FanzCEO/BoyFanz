...
const FEATURED_AFFILIATES = [
  {
    id: '1',
    name: 'Premium Gear',
    logo: 'https://placehold.co/150/8B0000/FFFFFF?text=PG',
  ...
  },
  {
    ...
    logo: 'https://placehold.co/150/00CED1/FFFFFF?text=LL',
  ...
  },
  {
    id: '3',
    name: 'Tech & Gadgets',
    logo: 'https://placehold.co/150/32CD32/FFFFFF?text=TG',
  ...
  },
  {
    ...
    logo: 'https://placehold.co/150/ff6b35/FFFFFF?text=BE',
