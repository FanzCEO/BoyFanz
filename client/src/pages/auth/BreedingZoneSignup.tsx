...
import { Flame, Star, Zap, Camera, DollarSign, Users, ArrowRight, Check, Sparkles, Shield, Upload } from "lucide-react";
...
export default function BreedingZoneSignup() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-red-900/20 flex items-center justify-center p-4 relative">
      {/* Loading Overlay */}
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400">Setting up your Breeding Zone access...</p>
            </div>
          </div>
        </div>
      )}
        ...
        {currentStep !== 'welcome' && currentStep !== 'complete' && (
          <div className="mb-8">
            <div className="flex justify-between mb-2 text-sm">
              ...
              <span className="text-red-500">{Math.round(progress)}% Complete</span>
            </div>
            <Progress value={progress} className="h-2 bg-gray-800" />
          </div>
        )}

        <Card className="bg-gray-900/50 border-red-600/30 backdrop-blur-sm">

          {/* STEP 1: Welcome Screen */}
          {currentStep === 'welcome' && (
            <div className="p-8 md:p-12 text-center">
              <div className="mx-auto mb-6 w-20 h-20 bg-gradient-to-br from-red-600/20 to-orange-500/20 rounded-full flex items-center justify-center border border-red-600/30">
                <Flame className="h-10 w-10 text-red-600" />
              </div>
              <h1 className="text-4xl md:text-5xl font-['Bebas_Neue'] text-white mb-4 tracking-wide">
                Enter the Breeding Zone
              </h1>
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Join the most powerful creator tools in the game. Build your empire with 100% earnings, full content ownership, and premium creator features.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 max-w-3xl mx-auto">
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  ...
                  <p className="text-sm text-gray-400">Keep everything you make</p>
                </div>
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  <Shield className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <h3 className="text-white font-semibold mb-1">Full Ownership</h3>
                  <p className="text-sm text-gray-400">Your content, your rules</p>
                </div>
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  <Flame className="w-8 h-8 text-orange-500 mx-auto mb-2" />
                  <h3 className="text-white font-semibold mb-1">Premium Tools</h3>
                  <p className="text-sm text-gray-400">Advanced creator features</p>
                </div>
              </div>

              <Button
                onClick={handleNext}
                className="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 text-white px-8 py-6 text-lg"
          ...
          {currentStep === 'account' && (
            <div className="p-8">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Choose your preferred sign-up method</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="username" className="text-gray-300">Creator Username</Label>
                    <Input
                      id="username"
                      type="text"
                ...
                <div className="flex justify-between pt-4">
                  <Button onClick={handleBack} variant="outline" className="border-gray-700" data-testid="button-back-account">
                    Back
                  </Button>
                  <Button
                    onClick={handleNext}
          ...
          {currentStep === 'profile' && (
            <div className="p-8">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Tell your fans who you are</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="stageName" className="text-gray-300">Stage Name</Label>
                    <Input
                      id="stageName"
                ...
                <div>
                  <Label htmlFor="pronouns" className="text-gray-300">Pronouns (Optional)</Label>
                  <Input
                    id="pronouns"
                ...
                <div>
                  <Label className="text-gray-300 mb-3 block">Select Your Niches</Label>
                ...
                <div className="flex justify-between pt-4">
                  <Button onClick={handleBack} variant="outline" className="border-gray-700" data-testid="button-back-profile">
                    Back
                  </Button>
                  <Button
                    onClick={handleNext}
          ...
          {currentStep === 'verification' && (
            <div className="p-8">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Quick and secure identity verification</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="over18" className="text-sm text-gray-300 cursor-pointer">
                ...
                <div className="flex justify-between pt-4">
                  <Button onClick={handleBack} variant="outline" className="border-gray-700" data-testid="button-back-verification">
                    Back
                  </Button>
                  <Button
                    onClick={handleNext}
          ...
          {currentStep === 'complete' && (
            <div className="p-8 md:p-12 text-center">
              <div className="mx-auto mb-6 w-20 h-20 bg-gradient-to-br from-red-600/20 to-orange-500/20 rounded-full flex items-center justify-center border border-red-600/30 animate-pulse">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 max-w-3xl mx-auto">
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  ...
                  <p className="text-sm text-gray-400">Share photos, videos & more</p>
                </div>
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                ...
                <div className="p-4 rounded-lg bg-gray-800/50 border border-gray-700">
                  ...
                  <p className="text-sm text-gray-400">Get paid for every interaction</p>
                </div>
              </div>
