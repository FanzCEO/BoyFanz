...
type OnboardingStep = 'welcome' | 'account' | 'personalization' | 'complete';
...
export default function FanzSignup() {
  ...
  const steps: OnboardingStep[] = ['welcome', 'account', 'personalization', 'complete'];
          ...
          {currentStep === 'welcome' && (
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-xl text-zinc-400 mb-8 max-w-2xl mx-auto">
                Your new world of creators awaits. Discover exclusive content and connect with your favorite creators.
              </p>
