                ...
                <div className="p-4 rounded-lg bg-zinc-800/50 border border-zinc-700">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="flex gap-2">
                      <div className="w-10 h-6 bg-gradient-to-r from-red-500 to-red-600 rounded"></div>
                      <div className="w-10 h-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded"></div>
                      <div className="w-10 h-6 bg-gradient-to-r from-amber-500 to-amber-600 rounded"></div>
                    </div>
