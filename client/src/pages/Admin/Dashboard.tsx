          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card data-testid="card-recent-activity">
              ...
              <CardContent className="space-y-4">
                {Array.isArray(currentStats.recentActivity) && currentStats.recentActivity.map((activity: ActivityItem) => (
            ...
            <Card data-testid="card-system-alerts">
              ...
              <CardContent className="space-y-4">
                {Array.isArray(currentStats.alerts) && currentStats.alerts.map((alert: AlertItem) => (
            ...
            <Card data-testid="card-revenue-chart">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <AreaChart data={Array.isArray(currentStats.revenueChart) ? currentStats.revenueChart : []}>
            ...
            <Card data-testid="card-content-distribution">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={Array.isArray(currentStats.contentStats) ? currentStats.contentStats : []}
                      cx="50%"
                      cy="50%"
                      outerRadius={80}
                      fill="#8884d8"
                      ...
                      label
                    >
                      {Array.isArray(currentStats.contentStats) && currentStats.contentStats.map((entry: ContentStats, index: number) => (
          ...
          <Card data-testid="card-service-status">
            ...
            <CardContent>
              <div className="space-y-4">
                {Array.isArray(currentHealth.services) && currentHealth.services.map((service: ServiceStatus, index: number) => (
